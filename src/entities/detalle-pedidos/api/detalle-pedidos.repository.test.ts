...
describe('detallePedidosRepository', () => {
  ...
  it('create calls insert select single', async () => {
    ...
    await detallePedidosRepository.create(payload as any);
  ...
  it('update calls update eq select single', async () => {
    const payload = { id_detalle: '123' };
    await detallePedidosRepository.update('123', payload as any);
  ...
  it('remove calls delete eq', async () => {
    await detallePedidosRepository.remove('123');
