...
describe('profilesRepository', () => {
  ...
  it('create calls insert select single', async () => {
    ...
    await profilesRepository.create(payload as any);
  ...
  it('update calls update eq select single', async () => {
    const payload = { id: '123' };
    await profilesRepository.update('123', payload as any);
  ...
  it('remove calls delete eq', async () => {
    await profilesRepository.remove('123');
